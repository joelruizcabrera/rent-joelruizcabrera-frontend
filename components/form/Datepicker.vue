<template>
  <div ref="datepickerRef" class="md:max-w-[380px] w-full cursor-pointer relative">
    <div class="relative mb-3">
      <input
          id="datepicker"
          type="text"
          placeholder="Datum auswählen *"
          class="h-12 w-full appearance-none placeholder:text-white font-light rounded-lg bg-linear-to-t from-neutral-950 to-neutral-900 pl-12 pr-4 text-white outline-none inset-shadow-xs inset-shadow-neutral-800 border-neutral-900 border-1 shadow-neutral-900 shadow-lg cursor-pointer"
          :value="updateInput()"
          @click="toggleDatepicker"
          readonly
      />
      <span @click="toggleDatepicker" class="absolute inset-y-0 flex h-12 w-12 items-center justify-center text-white">
            <svg
                width="21"
                height="20"
                viewBox="0 0 21 20"
